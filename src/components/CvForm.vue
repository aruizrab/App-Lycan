          ...
          >
            <template #item="{ element: contact, index }">
              <div class="flex gap-2 mb-2 items-center">
                <GripVertical class="contact-handle cursor-move text-gray-400 hover:text-gray-600" :size="20" />
                <select v-model="contact.type" class="rounded-md border-gray-300 dark:border-gray-600 border p-2 w-24 dark:bg-gray-700 dark:text-white">
                  <option value="email">Email</option>
                  <option value="phone">Phone</option>
                  <option value="url">Link</option>
                </select>
                <input v-model="contact.label" type="text" class="w-32 rounded-md border-gray-300 dark:border-gray-600 border p-2 dark:bg-gray-700 dark:text-white" placeholder="Label" />
                <input v-model="contact.value" type="text" class="flex-1 rounded-md border-gray-300 dark:border-gray-600 border p-2 dark:bg-gray-700 dark:text-white" placeholder="Value" />
                  ...
                  <div class="border dark:border-gray-700 p-3 rounded mb-3 relative group bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <div class="grid grid-cols-1 gap-3 pl-6">
                      ...
                      <div class="grid grid-cols-2 gap-2">
                        <input v-model="item.subtitle" placeholder="Organization / Company" class="border dark:border-gray-600 p-2 rounded dark:bg-gray-700 dark:text-white" :class="{'col-span-2': section.type === 'certifications'}" />
                      ...
                      <div v-if="section.type === 'projects'" class="space-y-2">
                         ...
                         <div class="flex gap-2">
                            <input v-model="item.skillsLabel" placeholder="Label (e.g. Tech Stack)" class="w-1/3 border dark:border-gray-600 p-2 rounded dark:bg-gray-700 dark:text-white" />
                            <input v-model="item.skills" placeholder="Skills (comma separated)" class="w-2/3 border dark:border-gray-600 p-2 rounded dark:bg-gray-700 dark:text-white" />
                         </div>
                      </div>
