...
// Tab configuration
const TABS = [
    { id: PROMPT_TYPES.JOB_ANALYSIS, name: 'Job Analysis', icon: Briefcase },
    { id: PROMPT_TYPES.MATCH_REPORT, name: 'Match Report', icon: Target },
    { id: PROMPT_TYPES.COMPANY_RESEARCH, name: 'Company Research', icon: Building },
    { id: PROMPT_TYPES.CV_GENERATION, name: 'CV Generation', icon: FileText },
    { id: PROMPT_TYPES.COVER_LETTER, name: 'Cover Letter', icon: Mail }
]
...
const resetToDefault = () => {
    if (confirm('Reset to default prompt? Your selection will change but custom prompts will be preserved.')) {
...
<template>
    <div class="h-full flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto p-4">
            ...
            <!-- New Prompt Form -->
            <div v-if="showNewPromptForm" class="mb-4 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-2">
                ...
                >
                        ...
                        <div class="flex items-center gap-3 min-w-0">
                            ...
                            <div class="min-w-0">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span v-if="prompt.isDefault" class="px-1.5 py-0.5 text-xs rounded bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400">
                                        Default
                                    </span>
                                </div>
                    ...
                    <!-- Expanded Content -->
                    <div v-if="expandedPromptId === prompt.id" class="border-t border-gray-100 dark:border-gray-700">
                        <!-- Edit Mode -->
